...
export default function NavBar({toggle , setTheme}) {
  ...
  return (
    <div className='p-5 '>
       ...
       <div className='flex text-3xl font-bold text-blue-700 justify-between '>
        <div onClick={()=>{
            navigate("/")
        ...
        Product Store
          ...
          <div className='p-2'>
          <svg className="w-6 h-6 text-blue-800 text-blue-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
  ...
  <path d="m19.102 16.163-.272.183c-2.557 1.74-4.169 2.64-4.698 2.935a4.083 4.083 0 0 1-2 .53 3.946 3.946 0 0 1-1.983-.535 3.788 3.788 0 0 1-1.36-1.361 3.752 3.752 0 0 1-.51-1.85 1.812 1.812 0 0 1-.043-.26V9.143c0-.024.009-.046.01-.07-.056.02-.11.043-.162.07a1.796 1.796 0 0 0-.787 1.516v6.377a10.67 10.67 0 0 0 1.113 4.27 10.11 10.11 0 0 0 8.505-.53 10.022 10.022 0 0 0 3.282-2.858 9.936 9.936 0 0 0 1.75-3.97 19.615 19.615 0 0 1-2.845 2.216Z"/>
          ...
          <div className=' flex p-2 mr-12'>
          <div onClick={()=>{
            navigate("/create")
          }} className='pr-2 cursor-pointer'>
          <svg className={`w-6 h-6 text-gray-800 ${toggle==="white" ? "text-black": "text-white"}`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
         ...
         <div onClick={setTheme} className='pl-2 cursor-pointer'>
         <svg className={`w-6 h-6 text-gray-800 ${toggle==="white" ? "text-black" : "text-white"}`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
